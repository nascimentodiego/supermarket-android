...
/**
 * The type Get products observable.
 */
/*
 ...
 */
public class GetProductsObservable extends GenericObservable {
    /**
     * Instantiates a new Get products observable.
     *
     * @param filter the filter
     */
    public GetProductsObservable(String filter) {
        myObservable = apiDataRequest.getProduct(token, filter)
